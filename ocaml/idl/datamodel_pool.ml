...
let set_limit_console_sessions =
  call ~name:"set_limit_console_sessions"
    ~doc:
      "Set the console concurrent limit for all hosts and VMs in the pool."
    ~lifecycle:[]
    ~params:
      [
        (Ref _pool, "self", "The pool")
